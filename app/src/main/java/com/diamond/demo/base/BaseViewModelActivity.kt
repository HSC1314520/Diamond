...
/**
 * Description: [android.app.Activity] base class based on the
 * MVVM framework.
 *
 * @author BigTree
 * @date 2024/9/17
 * @since 1.0.0
 */
abstract class BaseViewModelActivity<VB : ViewDataBinding, VM: BaseViewModel> : DiamondBaseViewModelActivity<VB, VM>() {
